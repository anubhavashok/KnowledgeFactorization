...
# Following 2 classes are new - Bhav Ashok
class BasicBlockModifiable(nn.Module):
    expansion = 1
    
    def __init__(self, shortcut=None):
        super(BasicBlockModifiable, self).__init__()
...
class ResNetModifiable(nn.Module):
    def __init__(self):
        super(ResNetModifiable, self).__init__()
