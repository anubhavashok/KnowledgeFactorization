...
parser.add_argument('--batch-size', type=int, default=256, metavar='N', help='batch size of train')
parser.add_argument('--epochs', type=int, default=5, metavar='N', help='number of epochs to train for')
parser.add_argument('--learning-rate', type=float, default=0.01, metavar='LR', help='learning rate')
...
traindir = '/mnt/sdb1/anubhava/imagenet32/train/box'
valdir = '/mnt/sdb1/anubhava/imagenet32/val/box'
